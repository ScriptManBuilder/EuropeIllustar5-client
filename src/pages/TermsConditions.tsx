  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          This digital illustration course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        ...
        <Paragraph>
          Our digital illustration courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for digital illustration course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "ILLUSTAR COURSES" or "ILLUSTAR.COURSES". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased digital illustration courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All digital illustration course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our digital illustration course content to reflect the latest developments in digital art, character design, and professional illustration techniques. 
