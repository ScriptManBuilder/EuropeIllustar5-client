...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          {COMPANY_INFO.name} delivers digital illustration courses digitally through our secure online learning platform. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our digital illustration courses are 100% digital products.</strong> There are no physical items to ship. All course materials, 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased digital illustration courses. No waiting, no shipping delays - 
