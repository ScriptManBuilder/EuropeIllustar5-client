...
const Account: React.FC = () => {
  ...
  // Данные курсов цифровой иллюстрации из products.ts
        ...
        <div>
          ...
          <InfoCard>
            ...
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any Digital Illustration course, you'll have lifetime access to all course materials, 
    ...
    return (
      <div>
        ...
        <div style={{ 
          ...
          }}>Continue your Digital Illustration mastery journey</p>
          <div style={{ 
            display: 'flex', 
