...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our digital illustration courses and want you to be satisfied with your learning experience. 
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all digital illustration course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your digital illustration course purchase:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "ILLUSTAR COURSES" or "ILLUSTAR.COURSES" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different digital illustration course that better suits your needs<br/>
